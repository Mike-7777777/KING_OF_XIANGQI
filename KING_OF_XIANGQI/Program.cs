    ...
    class Program
    {
        ...
        public static bool Play(Controller controller, Table table, View view, string color)
        {
            ...
            if (checkwin == false)
            {
                ...
                {
                    Console.WriteLine("The coordinate is not a right coordinate.");
                    Play(controller, table, view, color);
                }
                catch (FormatException)
                {
                    Console.WriteLine("The format of the input is not a right format. \n" +
                        "The right example is 4,9. Please try again.");
                    Play(controller, table, view, color);
                }
                catch (Exception ex)
                {
